...
zkgov_check get_eth_id 0x50e420474a6967eaac87813fe6479e98ae8d380fd9b3ae78bc4fedc443d9dec1 --rpc-url $ZKSYNC_RPC_URL --show-solidity
# ZIP-5 get the final ETH proposal ID based off an input JSON object
zkgov_check get_eth_id_from_file proposal.json
```
