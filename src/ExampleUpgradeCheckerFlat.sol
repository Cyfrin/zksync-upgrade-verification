...
// src/UpgradeCheckerFlat.sol

contract ExampleUpgradeCheckerFlat {
    function execute(IProtocolUpgradeHandler.UpgradeProposal calldata _proposal) external payable {}
    ...
    IProtocolUpgradeHandler.Call callTwo = IProtocolUpgradeHandler.Call({
        target: 0x303a465B659cBB0ab36eE643eA362c509EEb5213,
        value: 0,
        data: hex"79ba5097"
    });
    IProtocolUpgradeHandler.Call callThree = IProtocolUpgradeHandler.Call({
        target: 0xc2eE6b6af7d616f6e27ce7F4A451Aedc2b0F5f5C,
        value: 0,
        data: hex"79ba5097"
    });
    IProtocolUpgradeHandler.Call callFour = IProtocolUpgradeHandler.Call({
